...
function CourseCard({ course }) {
    return (
        <Link to={course.href} className="group block bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-100">
                    ...
                    <div className="flex flex-wrap gap-2">
                        {courseTabs.map((tab) => (
                            <button
                                ...
                                className={`text-xs font-semibold px-3 py-1.5 rounded-full border transition-all ${activeTab === tab
            ...
            <div className="max-w-[1190px] mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div className="flex flex-col gap-4">
                        <Link to="/layout2/courses" className="block rounded-xl overflow-hidden hover:opacity-90 transition-opacity shadow-sm">
        ...
        <section className="py-10 bg-[#f5fbf6]">
            <div className="max-w-[1190px] mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {posts.map((post, i) => (
                        <Link key={i} to={post.href} className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-100">
